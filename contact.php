...
<div class="contact">
	<div class="container">
		...
		<div class="col-md-3 col-sm-3 contact-left">
			<div class="address">
				<h4>Alamat</h4>
				<h5>Teknik Informatika Lt 3</h5>
				<h5>Keputih Surabaya</h5>
			</div>
			<div class="phone">
				<h4>PHONE</h4>
				<h5>+6289631551715.</h5>
			...
			<div class="email">
				<h4>EMAIL</h4>
				<h5><a href="mailto:info@example.com">rifat@gmail.com</a></h5>
				<h5><a href="mailto:info@example.com">sekbay@yahoo.com</a></h5>
			</div>
		</div>
