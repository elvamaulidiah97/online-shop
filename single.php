...
<div class="products">	 
		<div class="container">  
				...
				<div class="single-page-row" id="detail-21">
					<div class="col-md-6 single-top-left">	
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="images/single1.jpg">
									 <div class="thumb-image"> <img src="images/single1.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
								</li>
								<li data-thumb="images/single2.jpg">
									<div class="thumb-image detail_images"> <img src="images/single2.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
								</li>
								<li data-thumb="images/single3.jpg">
								   <div class="thumb-image"> <img src="images/single3.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
								</li> 
							</ul>
						</div>
					</div>
					<div class="col-md-6 single-top-right">
						<h3 class="item_name"> Itang Yunasj</h3>
						<p>Waktu pengiriman: barang akan dikirim dalam 2-3 hari kerja. </p>
						...
						<div class="single-price">
							<ul>
								<li>RP 360.000</li>  
								<li><del>RP 400000</del></li> 
								<li><span class="w3off">Diskon 10%!!</span></li> 
								<li>Sampai: 4 Juni 2017</li>
								<li><a href="#"><i class="fa fa-gift" aria-hidden="true"></i> Voucher</a></li>
							</ul>	
						</div> 
						<p class="single-price-text">- Baju Koko
							- Poliester<br>
							- Abu-abu muda<br>
							- Stand up collar<br>
							- Lengan pendek<br>
						...
						<form action="#" method="post">
							...
							<button type="submit" class="w3ls-cart" ><i class="fa fa-cart-plus" aria-hidden="true"></i> Pesan</button>
						</form>
			...
			<div class="collpse tabs">
				<h3 class="w3ls-title">Tentang produk ini</h3> 
				<div class="panel-group collpse" id="accordion" role="tablist" aria-multiselectable="true">
					<div class="panel panel-default">
						...
						<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
							<div class="panel-body">
								Produk ini terbuat dari benang serat ultra
							</div>
						</div>
					</div>
					<div class="panel panel-default">
					...
					<div class="panel panel-default">
						...
						<div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
							<div class="panel-body">
								Bahannya nyaman dan tidak luntur
							</div>
						</div>
					</div>
					<div class="panel panel-default">
						...
						<div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
							<div class="panel-body">
								Silakan hubungi kami jikalau ada yang ingin ditanyakan
							</div>
						</div>
					</div>
				</div>
