		...
		<div class="col-md-6 features">
			...
			<div class="support">
				...
				<div class="col-md-10 ftext">
					...
					<p>Anda butuh bantuan? Kami siap melayani anda.</p>
				</div>
				<div class="clearfix"></div>
			</div>
			<div class="shipping">
				...
				<div class="col-md-10 ftext">
					<h4>Free shipping</h4>
					<p>Kirim kemanapun menjadi lebih mudah.</p>
				</div>
				<div class="clearfix"></div>
			</div>
			<div class="money-back">
				...
				<div class="col-md-10 ftext">
					...
					<p>Kami jamin barang yang kami kirim merupakan barang kualitas terbaik.</p>
				</div>
				<div class="clearfix"></div>
			</div>
		</div>
					...
					<div class="wmuSliderWrapper">
						<article style="position: absolute; width: 100%; opacity: 0;">
							<div class="banner-wrap">
								...
								<p>Semenjak beli barang di olshop ini, saya jadi merasa lebih kekinian. </p>
								<h4># Hendra</h4>
							</div>
						</article>
						<article style="position: absolute; width: 100%; opacity: 0;">
							<div class="banner-wrap">
								...
								<p>Semenjak beli barang di olshop ini, kualitas hidup saya meningkat. </p>
								<h4># Kurnia</h4>
							</div>
						</article>
						<article style="position: absolute; width: 100%; opacity: 0;">
							<div class="banner-wrap">
								...
								<p>I can't say but I'd love visiting your online shop, it is awesome. </p>
								<h4># Elva</h4>
							</div>
						</article>
					</div>
